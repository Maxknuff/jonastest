        ...
        <>
          ...
          >
            ...
            <div className="p-6 flex items-center justify-between border-b border-gray-100">
              ...
              <button onClick={() => isCartOpen.set(false)} className="p-2 hover:bg-gray-100 rounded-full transition-colors">
                <X size={20} />
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              {$cartItems.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-gray-400 space-y-4">
                  ...
                  <button onClick={() => isCartOpen.set(false)} className="text-[#0071E3] font-bold hover:underline">
                    Jetzt einkaufen
                  </button>
                </div>
              ) : (
            ...
            {$cartItems.length > 0 && (
              <div className="p-6 border-t border-gray-100 bg-white">
                ...
                <a href="/checkout" className="w-full bg-[#0071E3] text-white py-4 rounded-2xl font-bold hover:bg-[#0077ED] transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20 active:scale-95">
